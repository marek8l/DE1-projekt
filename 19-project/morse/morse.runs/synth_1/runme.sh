...
HD_PWD='C:/Users/marek/Desktop/DE projekt/DE1-projekt/09-project/morse/morse.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inputM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inputM.tcl
